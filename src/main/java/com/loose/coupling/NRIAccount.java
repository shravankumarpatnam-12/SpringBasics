...
public class NRIAccount implements Account{
    ...
    public NRIAccount(int accountNumber, String nriType, String countryOfResidence,
                      double balance, double interestRate, String currency, LocalDate openedDate, boolean isActive) {
    ...
    public void calculateInterest() {
        if (isActive) {
            ...
            System.out.println("NRI Account"+ accountNumber+"closed hence interest cannot be calculated");
        }
    }
